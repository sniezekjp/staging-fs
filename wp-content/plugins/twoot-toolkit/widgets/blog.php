...
if(!class_exists('Twoot_Widget_Blog')) {

	class Twoot_Widget_Blog extends WP_Widget {
		...
		//Constructor
		function Twoot_Widget_Blog() {

			/* Widget variable settings. */
			$this->widget_cssclass 		= 'widget-blog widget-post';
			$this->widget_description 	= __( 'This widget will display a blog section.', 'Twoot_Toolkit' );
			$this->widget_name 			= __( 'Twoot Blog Posts', 'Twoot_Toolkit' );

			$widget_ops = array( 'classname' => $this->widget_cssclass, 'description' => $this->widget_description );

			$this->WP_Widget( TWOOT_TOOLKIT_SLUG. '_blog', $this->widget_name, $widget_ops );
		}
	...
	register_widget('Twoot_Widget_Blog');
}
?>