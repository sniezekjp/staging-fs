...
if ( !function_exists( 'shortcode_best_sellers_product_carousel' ) ) {
	function shortcode_best_sellers_product_carousel($atts, $content = null) {
	...
	add_shortcode('best_sellers_product_carousel', 'shortcode_best_sellers_product_carousel');
}
