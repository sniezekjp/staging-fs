...
if ( !function_exists( 'shortcode_hr' ) ) {
	...
	function shortcode_hr($atts, $content = null) {
		...
		$top_class=$top!==false? ' mt-'.$top:'';
		$bottom_class=$bottom!==false? ' mp-'.$bottom:'';

		$output = '<div class="shortcode-hr'.$top_class.$bottom_class.'"></div>'."\n";
...
if ( !function_exists( 'shortcode_br' ) ) {
	...
	function shortcode_br($atts, $content = null) {
		...
		$output = '<div class="shortcode-br'.$top_class.'"></div>'."\n";
