...
<form id="order_review" method="post">
	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php _e( 'Qty', 'Twoot' ); ?></th>
				<th class="product-total"><?php _e( 'Totals', 'Twoot' ); ?></th>
			</tr>
		</thead>
		<tfoot>
		<?php
	...
	<div id="payment" class="mt-40">
		...
		<ul class="payment_methods methods">
			<?php
				if ( $available_gateways = $woocommerce->payment_gateways->get_available_payment_gateways() ) {
					...
					echo '<p>'.__( 'Sorry, it seems that there are no available payment methods for your location. Please contact us if you require assistance or wish to make alternate arrangements.', 'Twoot' ).'</p>';
		...
		<div class="form-row">
			...
			<input type="submit" class="button alt" id="place_order" value="<?php _e( 'Pay for order', 'Twoot' ); ?>" />
